...
export default function LanguageSelection() {
  return <main style={{ minHeight: "100svh", display: "grid", placeItems: "center", padding: 24, background: "#f4f6f8", fontFamily: "Arial, sans-serif", color: "#232734" }}>
    <section style={{ width: "min(100%, 680px)", padding: 32, borderRadius: 22, background: "white", boxShadow: "0 18px 55px rgba(35,39,52,.12)", textAlign: "center" }}>
      ...
      <p style={{ margin: "0 0 26px", color: "#68707d" }}>Sprache wählen · Choose language · Kies een taal</p>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(130px, 1fr))", gap: 12 }}>
        ...
        <Link href="/nl/" style={{ padding: 16, borderRadius: 12, background: "#4a5262", color: "white", textDecoration: "none", fontWeight: 800 }}>Nederlands</Link>
      </div>
    </section>
  </main>;
}
